defmodule Sitemap.Adapter.VirtualTest do
  use ExUnit.Case
  ...
  defmodule Myapp do
    use Sitemap, adapter: Sitemap.Adapter.Virtual


    def generate do
      create host: "http://example.com" do
  ...
  test "Genreate valid sitemap" do
    assert IO.iodata_to_binary(Myapp.generate()) == @expected
  end
end
